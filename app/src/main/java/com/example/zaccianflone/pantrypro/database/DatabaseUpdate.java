...
public abstract class DatabaseUpdate {
    public final void update(HashMap<String, Object> values, String type) {
        child(type);
        execute(values, type);
        finish();
    }

    public abstract void child(String type);
    public abstract void execute(HashMap<String, Object> values, String type);
